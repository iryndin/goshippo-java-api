...
public enum CountryCodeEnum {
    ...
    private static final Map<String, CountryCodeEnum> alpha3Map = new HashMap<>();
    private static final Map<Integer, CountryCodeEnum> numericMap = new HashMap<>();
    ...
    public static CountryCodeEnum fromString(final String s) {
        if (s != null) {
            for (CountryCodeEnum e : CountryCodeEnum.values()) {
